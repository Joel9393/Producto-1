...
//Constructor	
	...
	public void aniadir(int numPedido,float unidad,LocalDate fechaPedido,LocalTime horaPedido, String codigo, String nif) throws Exception {
		...
		Pedido pedido = new Pedido(numPedido,unidad,fechaPedido,horaPedido,articulo,cliente);
	 	if (yaExiste(pedido.getNumPedido())) {
	 		throw new Exception ("Este pedido ya está registrado");
	 	}
	 	else {
	 		lista.add(pedido);
	 	}
